...
namespace LiftPassPricingTests
{
    ...
    public class PricesTest : IClassFixture<TestConfiguration>
    {
        private readonly LiftPassModule prices;
        private readonly Browser browser;

        public PricesTest(TestConfiguration configuration)
        {
            this.prices = new LiftPassModule(configuration.PricingControler);
        ...
        [InlineData("1jour", 35)]
        [InlineData("night", 19)]
        public void CreateOrUpdatePrice(string type, int cost)
        {
